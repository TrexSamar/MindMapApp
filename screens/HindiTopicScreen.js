...
export default class HindiTopicScreen extends React.Component{
    ...
    render(){
        return(
            ...
            onPress = {()=>{this.props.navigation.navigate('H1')}}
            >
...
<TouchableOpacity style = {styles.topicContainer}
onPress = {()=>{this.props.navigation.navigate('H2')}}
>
...
<TouchableOpacity style = {styles.topicContainer}
onPress = {()=>{this.props.navigation.navigate('H3')}}
>
...
<TouchableOpacity style = {styles.topicContainer}
onPress = {()=>{this.props.navigation.navigate('H4')}}
>
